/*! practical-forms v3.0.0 | (c) 2016, JJ Programs, LLC | Distributed under the MIT License */
angular.module('jjp.practical-forms.templates', []).run(['$templateCache', function($templateCache) {
  $templateCache.put("/jjp/pf/validation.html",
    "<span ng-messages=subform.name.$error ng-show=\"subform.name.$invalid && subform.name.$dirty\" role=alert>&nbsp;&nbsp; <span ng-message=zipcode>{{::config.validation.labels.zipcode}}</span> <span ng-message=phone>{{::config.validation.labels.phone}}</span> <span ng-message=stateCode>{{::config.validation.labels.stateCode}}</span> <span ng-message=email>{{::config.validation.labels.email}}</span> <span ng-message=password>{{::config.validation.labels.password}}</span> <span ng-message=required>{{::config.validation.labels.required}}</span> <span ng-message=pattern>{{::config.validation.labels.pattern}}</span> <span ng-message=confirm>{{::config.validation.labels.confirm}}</span> <span ng-message=number>{{::config.validation.labels.number}}</span> <span ng-message=percent>{{::config.validation.labels.percent}}</span> <span ng-message=pattern>{{::config.validation.labels.pattern}}</span> <span ng-message=url>{{::config.validation.labels.url}}</span> <span ng-message=minlength>{{::config.validation.labels.minlength}}</span> <span ng-message=maxlength>{{::config.validation.labels.maxlength}}</span> <span ng-message=min>{{::config.validation.labels.min}}</span> <span ng-message=max>{{::config.validation.labels.max}}</span></span> <span ng-show=\"subform.name.$valid && subform.name.$dirty\" role=alert ng-if=config.validation.labels.valid>&nbsp;&nbsp;{{::config.validation.labels.valid}}</span>");
  ...
  $templateCache.put("/jjp/pf/textarea.html",
    "<div class=\"pf pf-input\" class=\"form-group has-feedback\" ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\" ng-form=subform tabindex=-1><label class=control-label for={{::id}}>{{title}} <span class=pf-required ng-if=\"required || ngRequired\">{{::config.requiredChar}}</span> <span ng-include=\"'/jjp/pf/validation.html'\"></span></label><p class=FormHint id={{::id}}-tip ng-show=hasTransclude ng-transclude><div class=pf-form-control><textarea aria-describedby={{::id}}-tip class=form-control id={{::id}} name=name ng-trim=1 ng-maxlength=ngMaxlength ng-minlength=ngMinlength ng-model=ngModel ng-disabled=ngDisabled ng-required=ngRequired placeholder={{placeholder}} required>\n" +
