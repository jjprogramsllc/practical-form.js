...
var module=angular.module("jjp.practical-forms",["jjp.practical-forms.templates","ui.bootstrap"]);module.directive("pfCheckboxInput",function(){return{restrict:"E",scope:{title:"@"},transclude:!0,replace:!0,template:'<div class="checkbox"><label><span ng-transclude></span>{{title}}</label></div>'}}),module.directive("pfEmailInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/email.html"}}),module.directive("pfNumberInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/number.html"}}),module.directive("pfOptionGroup",function(){return{restrict:"E",scope:{title:"@",description:"@?",required:"=?"},transclude:!0,replace:!0,templateUrl:"/jjp/pf/options.html",link:function(a,b,c){a.required&&b.find(":input").attr("required","required"),a.$watch("subform.$invalid",function(b){a.isError=b}),a.$watch("subform.$dirty",function(b){a.isDirty=b})}}}),module.directive("pfPasswordInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"="},replace:!0,transclude:!0,templateUrl:"/jjp/pf/password.html"}}),module.directive("pfRegexInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?",ngMinlength:"=?",ngMaxlength:"=?",ngPattern:"@?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/pattern.html"}}),module.directive("pfPercentageInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/percentage.html"}}),module.directive("pfPercentageMask",function(){return{restrict:"A",require:"ngModel",link:function(a,b,c,d){d.$formatters.push(function(a){return new praticalForms.Percentage(a).pretty()}),d.$parsers.push(function(a){var b=new praticalForms.Percentage(a);return b.pretty()!=d.$viewValue&&(d.$setViewValue(b.pretty()),d.$render()),b.value()>=0&&b.value()<=100?d.$setValidity("percent",!0):d.$setValidity("percent",!1),String(b.value())})}}}),function(a,b){a.Percentage=function(b){b=String(b);var c=b.indexOf("%")<0&&!a.endsWith(b,"%"),d=String(b).replace(/^0*/,"");this._value=d.replace(/[^0-9]/g,""),c&&this.backspace()},a.Percentage.prototype.value=function(){return parseFloat(this._value)||0},a.Percentage.prototype.pretty=function(){return this.value()>9?this.value()+" %":"0"+this.value()+" %"},a.Percentage.prototype.backspace=function(){this._value=this._value.slice(0,this._value.length-1)},a.startsWith=function(a,b){return a.substring(0,b.length)===b},a.endsWith=function(a,b){return a.substring(a.length-b.length,a.length)===b}}(window.praticalForms=window.praticalForms||{}),module.directive("pfPhoneInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/phone.html"}}),module.factory("jjp.FileObject",["$q","$log",function(a,b){var c={ReadImage:function(b){var c=a.defer(),g=new FileReader;return g.onload=d(g,c),g.onerror=e(g,c),g.onprogress=f(g,c),g.readAsDataURL(b),c.promise}},d=function(a,b){return function(){b.resolve(a.result)}},e=function(a,b){return function(){b.reject(a.result)}},f=function(a,b){return function(a){b.notify(a)}};return c}]),module.directive("pfPictureUploader",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",preview:"=?",url:"@?",result:"=?",status:"=?",maxSize:"=?",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/picture.html",link:function(a,b){angular.element(b[0].querySelector(".file-selector")).bind("click",function(a){b[0].querySelector("input").click()}),angular.element(b[0].querySelector("input")).bind("change",function(b){"undefined"!=typeof(b.srcElement||b.target).files[0]&&a.$apply(function(){a.ngModel=(b.srcElement||b.target).files[0],a.Select()})})},controller:["$scope","$http","jjp.FileObject",function(a,b,c){a.Select=function(){return a.status=1,a.ngModel.size>a.size?(a.status=-10,void(a.result="Image is too Big!")):void c.ReadImage(a.ngModel).then(function(b){a.preview=b,a.status=2},function(b){a.status=-1,a.result=b,console.warn(b)},function(b){a.load=b})},a.Upload=function(){a.status=3;var c=new FormData;c.append("file",a.ngModel),b.post(a.url,c,{transformRequest:angular.identity,headers:{"Content-Type":void 0}}).success(function(b){a.status=4,a.result=b}).error(function(b){a.status=-1,a.result=b,console.warn(b)})},a.Remove=function(){a.ngModel=null,a.preview=null,a.status=0},a.CanUpload=function(){var b=new RegExp("^(ht|f)tp(s?)://(([a-zA-Z0-9-._]+(.[a-zA-Z0-9-._]+)+)|localhost)(/?)([a-zA-Z0-9-.?,'/\\+&amp;%$#_]*)?([dw./%+-=&amp;?:\\&quot;',|~;]*)$");return b.test(a.url)},a.size=a.maxSize||3e6,a.ngModel={},a.status=0,a.result={},a.showPreview=0,a.showUpload=a.CanUpload()}]}}),module.directive("pfRadioInput",function(){return{restrict:"E",scope:{title:"@"},transclude:!0,replace:!0,template:'<div class="radio"><label><span ng-transclude></span>{{title}}</label></div>'}}),module.directive("pfStateCodeInput",function(){return{require:["ngModel","^form"],restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",output:"@"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/state.html",link:function(a,b,c,d){var e=a.output||"code";console.log(b);var f=b.find("p").html();a.hasTransclude=f&&f.length>0||!1,console.log(a.hasTransclude);d[0];a.subform.name.$validators.stateCode=function(a){return a?a.toLowerCase()in STATES:!1},a.subform.name.$parsers.push(function(a){return a=a.toLowerCase(),a in STATES?"code"===e?2==a.length?a:STATES[a]:2==a.length?STATES[a]:a:void 0}),a.$watch("subform.name.$modelValue",function(a,b,c){a!==b&&""!==a&&c.subform.name.$setDirty()})}}});var STATES={alabama:"al",alaska:"ak",arizona:"az",arkansas:"ar",california:"ca",colorado:"co",connecticut:"ct",delaware:"de",florida:"fl",georgia:"ga",hawaii:"hi",idaho:"id",illinois:"il",indiana:"in",iowa:"ia",kansas:"ks",kentucky:"ky",louisiana:"la",maine:"me",maryland:"md",massachusetts:"ma",michigan:"mi",minnesota:"mn",mississippi:"ms",missouri:"mo",montana:"mt",nebraska:"ne",nevada:"nv","new hampshire":"nh","new jersey":"nj","new mexico":"nm","new york":"ny","north carolina":"nc","north dakota":"nd",ohio:"oh",oklahoma:"ok",oregon:"or",pennsylvania:"pa","rhode island":"ri","south carolina":"sc","south dakota":"sd",tennessee:"tn",texas:"tx",utah:"ut",vermont:"vt",virginia:"va",washington:"wa","west virginia":"wv",wisconsin:"wi",wyoming:"wy","american samoa":"as","district of columbia":"dc","federated states of micronesia":"fm",guam:"gu","marshall islands":"mh","northern mariana islands":"mp",palau:"pw","puerto rico":"pr","virgin islands":"vi","armed forces africa":"ae","armed forces americas":"aa","armed forces canada":"ae","armed forces europe":"ae","armed forces middle east":"ae","armed forces pacific":"ap",al:"alabama",ak:"alaska",az:"arizona",ar:"arkansas",ca:"california",co:"colorado",ct:"connecticut",de:"delaware",fl:"florida",ga:"georgia",hi:"hawaii",id:"idaho",il:"illinois","in":"indiana",ia:"iowa",ks:"kansas",ky:"kentucky",la:"louisiana",me:"maine",md:"maryland",ma:"massachusetts",mi:"michigan",mn:"minnesota",ms:"mississippi",mo:"missouri",mt:"montana",ne:"nebraska",nv:"nevada",nh:"new hampshire",nj:"new jersey",nm:"new mexico",ny:"new york",nc:"north carolina",nd:"north dakota",oh:"ohio",ok:"oklahoma",or:"oregon",pa:"pennsylvania",ri:"rhode island",sc:"south carolina",sd:"south dakota",tn:"tennessee",tx:"texas",ut:"utah",vt:"vermont",va:"virginia",wa:"washington",wv:"west virginia",wi:"wisconsin",wy:"wyoming",as:"american samoa",dc:"district of columbia",fm:"federated states of micronesia",gu:"guam",mh:"marshall islands",mp:"northern mariana islands",pw:"palau",pr:"puerto rico",vi:"virgin islands"};module.directive("pfTextInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/text.html"}}),module.directive("pfTextarea",function(){return{restrict:"E",scope:{title:"@",placeholder:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngMinlength:"=?",ngMaxlength:"=?",ngPattern:"@?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/textarea.html"}}),module.directive("pfUrlInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/url.html"}}),module.directive("pfZipCodeInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/zipcode.html"}}),module.directive("pfConfirm",["$modal",function(a){return{restrict:"A",scope:{pfTitle:"@",pfMessage:"@",pfConfirm:"&"},link:function(b,c,d){c.bind("click",function(){var c=b.pfMessage||"Are you sure ?",d=b.pfTitle||"Warning!",e='<div class="modal-header"><h1>'+d+"</h1></div>";e+='<div class="modal-body">'+c+"</div>",e+='<div class="modal-footer">',e+='<button class="btn btn-primary" ng-click="Ok()">OK</button>',e+='<button class="btn btn-warning" ng-click="Cancel()">Cancel</button></div>';var f=a.open({template:e,controller:["$scope","$modalInstance",function(a,b){a.Ok=function(){b.close()},a.Cancel=function(){b.dismiss("cancel")}}]});f.result.then(function(){b.pfConfirm()},function(){})})}}}]),module.directive("pfDateInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",format:"@?",minDate:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/date.html"}});