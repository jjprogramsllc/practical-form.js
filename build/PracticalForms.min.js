angular.module('jjp.PracticalForms.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/jjp/pf/password.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.minlength>- Must be Longer then {{ngMinlength}} characters</span> <span ng-show=subform.name.$error.maxlength>- Must be shorter then {{ngMaxlength}} characters</span> <span ng-show=subform.name.$error.pattern>- Must contain at least 1 lowercase letter, 1 uppercase letter, and 1 digit</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control type=password name=name ng-model=ngModel ng-minlength=8 ng-maxlength=255 ng-pattern=\"/(?=^.{8,}$)(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\\s)[0-9a-zA-Z!@#$%^&*()]*$/\" ng-required=true required> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/pattern.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.minlength>- Must be Longer then 0 characters</span> <span ng-show=subform.name.$error.maxlength>- Must be shorter then 255 characters</span> <span ng-show=subform.name.$error.pattern>- Invalid Input</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control name=name ng-model=ngModel ng-minlength=0 ng-maxlength=255 ng-required=ngRequired required ng-trim=\"ngTrim || true\" placeholder=\"{{placeholder}}\"> <span>{{ngModel}}</span> <span>{{ngMinlength}}</span> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/phone.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.pattern>- Invalid Input. Enter a valid phone number</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control name=name ng-model=ngModel ng-required=ngRequired required ng-trim=true ng-pattern=\"/\\D*([2-9]\\d{2})(\\D*)([2-9]\\d{2})(\\D*)(\\d{4})\\D*/\" placeholder=\"Ex: (123)-456-7890\"> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/state.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.pattern>- Invalid Input. Enter the TWO letter state code</span> <span ng-show=subform.name.$error.maxlength>- Invalid Input. Enter the TWO letter state code</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control name=name ng-model=ngModel ng-maxlength=2 ng-required=ngRequired required ng-trim=true ng-pattern=\"/[A-Za-z]{2}/\" placeholder=\"Ex: OH\"> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/text.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.minlength>- Must be Longer then 0 characters</span> <span ng-show=subform.name.$error.maxlength>- Must be shorter then 255 characters</span> <span ng-show=subform.name.$error.pattern>- Invalid Input</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control name=name ng-model=ngModel ng-minlength=0 ng-maxlength=255 ng-trim=1 ng-required=ngRequired required placeholder=\"{{placeholder}}\"> <span>{{ngModel}}</span> <span>{{ngMinlength}}</span> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  ...
  $templateCache.put("/jjp/pf/url.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.url>- Not a valid URL. Make sure it starts with 'http://'</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control type=url required name=name ng-model=ngModel ng-required=ngRequired required ng-trim=ngTrim placeholder=\"Ex: http://company.com\"> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/zipcode.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span> <span ng-show=subform.name.$error.pattern>- Invalid Zip Code. Plase enter the 5 digit zip code</span></span></label><p class=FormHint ng-transclude>Form Hint</p><input class=form-control name=name ng-model=ngModel ng-required=ngRequired required ng-pattern=\"/^\\d{5}(?:[-\\s]\\d{4})?$/\" ng-trim=ngTrim placeholder=\"Ex: 12345\"> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></div>");
  $templateCache.put("/jjp/pf/date.html",
    "<div class=\"form-group has-feedback\" ng-form=subform ng-class=\"{'has-error':subform.name.$invalid && subform.name.$dirty, 'has-success':!subform.name.$invalid && subform.name.$dirty }\"><label class=control-label>{{title}}<span ng-if=\"required || ngRequired\">*</span> <span ng-show=\"subform.name.$invalid && subform.name.$dirty\"><span ng-show=subform.name.$error.required>- Required!</span></span></label><p class=FormHint ng-transclude>Form Hint</p><p><input class=form-control ng-model=ngModel is-open=isOpen ng-required={{ngRequired}} ng-click=\"isOpen = true\" ng-focus=\"isOpen = true\" datepicker-popup=\"MMMM dd, yyyy\" min=\"minDate\"> <span class=\"glyphicon glyphicon-remove form-control-feedback\" ng-show=\"subform.name.$invalid && subform.name.$dirty\"></span> <span class=\"glyphicon glyphicon-ok form-control-feedback\" ng-show=\"!subform.name.$invalid && subform.name.$dirty\"></span></p></div>");
}]);

/*! PracticalForms 2014-10-01 */
var module=angular.module("jjp.PracticalForms",["jjp.PracticalForms.templates","ui.bootstrap"]);module.directive("pfCheckboxInput",function(){return{restrict:"E",scope:{title:"@"},transclude:!0,replace:!0,template:'<div class="checkbox"><label><span ng-transclude></span>{{title}}</label></div>'}}),module.directive("pfEmailInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/email.html"}}),module.directive("pfOptionGroup",function(){return{restrict:"E",require:"^form",scope:{title:"@",description:"@?",required:"=?"},transclude:!0,replace:!0,templateUrl:"/jjp/pf/options.html",link:function(a,b){a.required&&b.find(":input").attr("required","required"),a.$watch("subform.$invalid",function(b){a.isError=b}),a.$watch("subform.$dirty",function(b){a.isDirty=b})}}}),module.directive("pfPasswordInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"="},replace:!0,transclude:!0,templateUrl:"/jjp/pf/password.html"}}),module.directive("pfRegexInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?",ngMinlength:"=?",ngMaxlength:"=?",ngPattern:"@?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/pattern.html"}}),module.directive("pfPhoneInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/phone.html"}}),module.directive("pfRadioInput",function(){return{restrict:"E",scope:{title:"@"},transclude:!0,replace:!0,template:'<div class="radio"><label><span ng-transclude></span>{{title}}</label></div>'}}),module.directive("pfStateCodeInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/state.html"}}),module.directive("pfTextInput",function(){return{restrict:"E",scope:{title:"@",placeholder:"@?",ngModel:"=",required:"=?",ngRequired:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/text.html"}}),module.directive("pfTextarea",function(){return{restrict:"E",scope:{title:"@",placeholder:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngMinlength:"=?",ngMaxlength:"=?",ngPattern:"@?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/textarea.html"}}),module.directive("pfUrlInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/url.html"}}),module.directive("pfZipCodeInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",ngTrim:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/zipcode.html"}}),module.directive("pfConfirmDialog",["$modal",function(a){return{restrict:"A",scope:{pfTtile:"@",pfConfirm:"&",item:"="},link:function(b,c,d){c.bind("click",function(){var c=d.pfModalMessage||"Are you sure ?",e='<div class="modal-header"><h1>'+b.pfTitle+"</h1></div>";e+='<div class="modal-body">'+c+"</div>",e+='<div class="modal-footer"><button class="btn btn-primary" ng-click="Ok()">OK</button><button class="btn btn-warning" ng-click="Cancel()">Cancel</button></div>';var f=a.open({template:e,controller:["$scope","$modalInstance",function(a,b){a.ok=function(){b.close()},a.cancel=function(){b.dismiss("cancel")}}]});f.result.then(function(){b.pfConfirm({item:b.item})},function(){})})}}}]),module.directive("pfDateInput",function(){return{restrict:"E",scope:{title:"@",ngModel:"=",required:"=?",ngRequired:"=?",format:"@?",minDate:"=?"},replace:!0,transclude:!0,templateUrl:"/jjp/pf/date.html"}});